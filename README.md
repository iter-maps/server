...
| Data pipeline — transit-lines overlay (region-driven, from OSM) | ✅ done, proven on real data |
| Data pipeline — metro-stations overlay geometry, NeTEx | 🚧 see [`docs/roadmap/`](docs/roadmap/) |
